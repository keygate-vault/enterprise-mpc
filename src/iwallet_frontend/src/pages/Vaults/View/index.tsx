...
import { LeftOutlined, WalletFilled, WalletOutlined } from "@ant-design/icons";
  ...
  const fetchWalletDetail = async () => {
    try {
      ...
      setVault({
        ...
        blockchain: "eth",
        name: "Funding",
        id: "013ed431-c4cf-4b8f-9e05-8ce9c71aca63",
      });
    } catch (error) {
      api.error({
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    ...
                    <div key={index} className="flex items-center mb-4">
                      ...
                      <div className="ml-4">
                        <p className="text-gray-500">
                          {publicKeyToETHAddress(vault.name)}
                        </p>
                  ...
                  {btcWallets.map((wallet, index) => (
                    <div key={index} className="flex items-center mb-4">
                      ...
                      <div className="ml-4">
                        <p className="text-gray-500">
                          {publicKeyToBTCAddress(vault.name)}
                        </p>
                        <p className="font-bold">
                          {wallet.balance} BTC ($
                          {wallet.usdBalance.toLocaleString()})
